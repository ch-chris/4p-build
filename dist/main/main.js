...
(() => {
  ...
  // src/main/utils/loaderAnimation.ts
  init_live_reload();
  ...
  var loaderAnimation = function(targetOne, targetTwo) {
    gsapWithCSS.to(targetOne, {
      keyframes: [
        {
    ...
    gsapWithCSS.to(targetTwo, {
      opacity: 1,
      duration: loaderDuration
    });
  };
  function endLoaderAnimation(target) {
    target?.classList.add("hide");
  }

  // src/main/utils/onLoadAnimation.ts
  init_live_reload();
  var onLoadAnimation = function(targets, delayDuration = 2) {
    let onLoadTl = gsapWithCSS.timeline({
      defaults: {
        delay: delayDuration,
        duration: 0.5
      }
  ...
  // src/main/utils/renderAccordions.ts
  init_live_reload();
  var import_accordion_js = __toESM(require_accordion_min(), 1);
  var renderAccordions = function(elements) {
    const acc = new import_accordion_js.default(
      elements,
      {
        showMultiple: true,
        openOnInit: [0]
  ...
  // src/main/utils/revealAnimation.ts
  init_live_reload();
  ...
  var revealAnimation = function(targets) {
    targets.forEach((target) => {
      gsapWithCSS.fromTo(target, {
        y: 100,
        opacity: 0
      }, {
        y: 0,
  ...
  // src/main/main.ts
  var loaderEl = document.querySelector('[p-selector="loader"]');
  var loaderLogoEl = document.querySelector('[p-selector="loader-logo"]');
  var onLoadEls = Array.from(
    document.querySelectorAll('[p-selector="onload"]')
  );
  var accordions = Array.from(
