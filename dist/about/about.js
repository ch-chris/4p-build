...
(() => {
  ...
  var splideMainEl = document.querySelector('[p-slider="main"]');
  var splideNavEl = document.querySelector('[p-slider="nav"]');
  var dots = document.querySelectorAll(".timeline_path_dot");
